...
START_BUTTON_GROUP = InlineKeyboardMarkup(
    [   
        ...
        [
            InlineKeyboardButton(
                text="📣 Updates Channel", url="https://t.me/FLAME_NETWORK"
            ),
            InlineKeyboardButton(
                text="💬 Support Group", url="https://t.me/FLAME_MAINCHAT"
            ),                       
        ],
        [
            InlineKeyboardButton(
                text="🔗 Deploy your own bot", url="https://github.com/MayankRai30/Musix"
            ),                                  
        ]
    ]
)
